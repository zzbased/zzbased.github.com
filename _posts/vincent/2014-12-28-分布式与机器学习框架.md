...
- [BerkeleyX: CS190.1x Scalable Machine Learning](https://courses.edx.org/courses/BerkeleyX/CS190.1x/1T2015/info) 一个很棒的机器学习课程，覆盖：Spark大数据、线性回归、梯度下降、在线广告、分类数据、数据预处理之One-Hot Encoding、神经科学等内容。[讲义](http://docs.huihoo.com/machine-learning/scalable-machine-learning/)
